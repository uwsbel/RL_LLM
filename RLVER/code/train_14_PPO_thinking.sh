...
RUN_NAME="rlvr_small_ppo${BASE_MODEL//\//_}_${IF_THINK}_lr${LEARN_RATE}"
...
ray job submit --address="http://127.0.0.1:8265" \
    ...
    actor_rollout_ref.actor.optim.lr=$LEARN_RATE \
    ...
    +actor_rollout_ref.rollout.environment.per_turn_length=8192 \
