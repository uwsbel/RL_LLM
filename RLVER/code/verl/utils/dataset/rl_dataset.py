...
class RLHFDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        simulator_dir = os.path.join("/code/jingquaw-sandbox/RL_LLM/RLVER/code/saves", 'simulator')
...
class VirtualRLHFDataset(RLHFDataset):
    ...
    def __getitem__(self, item):
        ...
        # encode prompts without chat template
        if self.return_raw_chat:
            print("yes, we will return raw chat and with simulator")
            ...
            row_dict['simulator'] = player_simulator
            # print("raw_prompt",row_dict['raw_prompt'])
            print("the simulator is:", row_dict['simulator'])
        else:
            print("no, we will not return raw chat")
